...
const FilterScreen = (props: any) => {
  ...
  const { unEnableBrand, highLightBrand, unEnableColor, highLightColor, brand, color, priceMin, priceMax } = props.state;
  const { setModalVisible, setHighLightBrand, setUnEnableBrand, setHighLightColor, setUnEnableColor,setBrand, setColor,  setpriceMin, setpriceMax } = props.action;


  const handleFilter = (brand: string, color: string, minPrice: string, maxPrice: string) => {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.BuyingFormat}>
          ...
          <View style={styles.Format}>
            ...
            <Pressable onPress={() => { setVisibleBrand(!visibleBrand), setVisibleColor(false)}}>
          ...
          <View style={styles.Format}>
            ...
            <Pressable onPress={() => { setVisibleColor(!visibleColor), setVisibleBrand(false) }}>
        ...
        <Pressable style={{ position: 'absolute', width: '100%', bottom: 30, alignSelf: 'center' }} onPress={() => { handleFilter(brand, color,priceMin, priceMax); setModalVisible(false), setVisibleBrand(false), setVisibleColor(false)}}>
